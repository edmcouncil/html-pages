<template>
   <div class="container">
      <article>
         ...
         <img class="img-avatar" src="../assets/img/edm_staff_michael_meriton.png" alt="Michael Meriton, EDMC Co-Founder & COO<" align="left" />                
         <ul>
         ...
         <p class="text">
            <a
               ...
               ><b>Contact Michael Meriton</b></a> to learn more about OKG initiative.
         </p>
         <br><br>
         ...
         <ul>
            <li>Colin is a senior executive and consultant with 30 years’ experience in financial services. He specialises in architecture, data governance and data management, most recently as head of data architecture for the investment banking divisions of RBS and HSBC and as head of enterprise architecture for Willis Towers Watson. </li>
            <li>Colin combines an enthusiasm for all things data with experience in software development, technology operations and management of major change programmes.</li>
         </ul>
         <p class="text">
            <a
               class="bttn"
         ...
         <ul>
            ...
            <li>Michael is passionate about all things data and has spent his career working in the data & analytics domain for companies in Europe, the Middle East and Asia Pacific.</li>
            <li>Michael is based in Sydney, Australia where he works as an independent data management consultant. Michael assists the EDM Council on a part-time basis and provides on the ground support to our Australian and New Zealand membership.</li>
         </ul>
         <p class="text">
            <a
               class="bttn"
