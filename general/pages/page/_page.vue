...
<div>
    ...
    <div class="container">
        <main>
            <article class="full-page">
                <section v-for="sectionItem in page" :key="sectionItem.id" :class="sectionItem.type == 'download'?'blank':''">
                    <div v-if="sectionItem.type == 'text'">
                        <p v-for="item in sectionItem.items" :key="item.id" v-html="$md.render( item.text )">
                        </p>
                    </div>
                        ...
                        <div class="subsection">
                            <div v-for="item in sectionItem.items" :key="item.id">
                                <div class="image-container">
                                    <img :src="require(`~/assets/img/${item.img_name}`)" class="transparent-image" />
                                </div>
    ...
    <FooterComponent :copyright="copyright"></FooterComponent>
</div>
</template>
