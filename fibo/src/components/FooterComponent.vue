    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col col-lg-12">
          <p class="copyright">
            © {{ new Date().getFullYear() }} EDM Council. All rights reserved.
            DCAM and FIBO are registered trademarks of EDM Council. All other
            marks are the property of their respective owners. Membership
