    ...
    <div class="container">
      <div class="footer-contact row">
        ...
        <div class="col-md-3">
          ...
          <div class="phone footer-text">+1 (646) 722-4381</div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3 social">
          <a
            ...
            ><img class="social-icons-first" src="../assets/icons/social-icons-yt.svg"
          /></a>
          <a
      ...
      <div class="row">
        <div class="col-md-12">
          <p class="copyright">
            © 2020 EDM Council. All rights reserved. DCAM and FIBO are registered trademarks of EDM
