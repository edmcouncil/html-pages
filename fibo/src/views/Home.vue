...
-->
        ...
        <section>
          ...
          <p>
            ...
            the ways that those things can relate to one another. In this way,
          ...
          <p>
            ...
            it is based on Description Logic. The use of logic ensures that each
        ...
        <section>
          ...
          <p>
            ...
            over the years and represent a consensus of the common concepts as
          ...
          <p>
            ...
            BIAN, Bloomberg LP, Bureau of Economic Analysis (BEA, US Department
            of Commerce), Bureau of Labor Statistics (BLS, US Department of
            Commerce), Census Bureau (US Department of Commerce), Citigroup,
            Commodities Futures Trading Commission (CFTC), Credit Suisse,
            Deutsche Bank, Exprentis, Federal Reserve Bank of Kansas City,
            Goldman Sachs, HP Enterprise / Mphasis, MakoLab, Mizuho, NoMagic,
            Nordea Bank AB, Office of Financial Research (US Dept of the
            Treasury), Pinnacle Bank (Morgan Hill, California), Quarule, State
        ...
        <section>
          ...
          <p>
            ...
            community process with a mission to develop, maintain, and promote
            global platform-independent, machine-readable and unambiguous data
            standard that enables understanding of the financial terminology,
            cross-system federation and aggregation of data to improve
            effectiveness of decisions, to improve efficiency in regulatory
        ...
        <section>
          ...
          <p class="">
            ...
            <router-link :to="{ path: router('FIBO-Groups') }"
              >the FIBO Steering Group and the FIBO Community Group</router-link
            >.
          </p>
          <p>
            ...
            is the main platform for the FIBO Community Group discussion. Please
            read
            <a
