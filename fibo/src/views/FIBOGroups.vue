...
<p class="text">Day-to-day ontology development is carried out by the <b>OKG Interest Groups</b>. The Interest Groups are always ontology-specific. Currently, we have got two EDMC Interest Groups: FIBO and AUTO. Each of them proposes, discusses, and prepares changes to their ontologies.</p>

<h3>OKG Work Groups</h3>
<p class="text">
Inside the FIBO and AUTO Interest Groups, we have smaller <b>OKG Working Groups</b> that focus on developing a chosen ontology part. In FIBO, the working groups are called FIBO Content Teams (FCTs). Currently, we have three active FCTs that focus on DER, SEC, and IND. Soon, we are planning to restart FIBO LOAN CT meetings.</p>
...
<p>
  Since January 2020
<ul>
  <li>the <a href="https://github.com/edmcouncil/fibo" v-on:click="outboundLinkClick('https://github.com/edmcouncil/fibo')">FIBO GitHub repository</a> is the main FIBO development space and the space where all the official FIBO materials are located, and </li>
  <li>the <a href="https://edmconnect.edmcouncil.org/fibointerestgroup/home" v-on:click="outboundLinkClick('https://edmconnect.edmcouncil.org/fibointerestgroup/home')">EDMConnect platform</a> is an official discussion forum for the FIBO Community.</li>
</ul>
