<template>
    ...
    >
      <div class="carousel-inner col-lg-10">
        <div class="carousel-item active">
          <span class="text-display">IDMP Common Core Ontology</span>
          <h2>Pistoia Alliance Project</h2>
  ...
  'https://marketing.pistoiaalliance.org/hubfs/Projects-Innovation/Ontology/PA_IDMP-Ontology_Executive-Project-Summary.pdf'
        ...
        <div class="carousel-item">
          <span class="text-display">Project Info Pack</span>
          <h2>Info Package for the Cross-Industry Initiative</h2>
