    ...
    >
      <div class="carousel-inner col-lg-10">
        <div class="carousel-item active">
          <span class="text-display">AUTOMOTIVE ONTOLOGY</span>
          <h2>
            The entirely new branch of the EDMC OKG initiative focused on
            Automotive Industry applications of Knowledge Graphs
          </h2>

          <router-link :to="{ path: router('') }"
            >About Automotive Ontology</router-link
          >
        </div>
        <div class="carousel-item">
          <span class="text-display">AUTOMOTIVE ONTOLOGY</span>
          <h2>
            A wide range of vital applications from the unique aspects of
            traditional and autonomous vehicles safety to the cross-industry
            edge computing applications
          </h2>

          <router-link :to="{ path: router('Applications') }"
            >APPLICATIONS</router-link
          >
        </div>
        <div class="carousel-item">
          <span class="text-display">AUTOMOTIVE COMMUNITY</span>
          <h2>
            The new activity will engage members of existing W3C’s Automotive
            Ontology Community Group
          </h2>

          <router-link :to="{ path: router('Community') }"
