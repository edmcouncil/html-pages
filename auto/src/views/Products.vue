        ...
        <table class="table table-hover">
          <tbody>
            ...
            <tr>
              ...
              <td>
                Auto schema.org ontology: A schema.org-compliant fundamental ontology for vehicle
              ...
              <td>
                <router-link
                  :to="{
                    path: router('ontology'),
                    query: {
                      query: encodeURI(
                        'https://spec.edmcouncil.org/auto/ontology/EC/AutoSchemaOrg/'
                      ),
                    },
                  }"
                  >Auto Viewer</router-link
                >
              </td>
            </tr>
            <tr>
              ...
              <td>
                AUTO Compatibility: A schema.org-compliant ontology for vehicle configuration
                information.
              </td>
              <td>Planned</td>
              <td>N/A</td>
            ...
            <tr>
              ...
              <td>
                AUTO Vehicle Lifetime Information: A schema.org-compliant ontology for vehicle
            ...
            <tr>
              ...
              <td>
                AUTO Vehicle Data Backbone: An ontology for information interchange within a
                vehicle, between vehicles, and between vehicles and their external entities.
              </td>
              <td>Planned</td>
              <td>N/A</td>
            </tr>
