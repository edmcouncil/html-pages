            ...
            <div class="row" v-if="data">
              <div class="col-12">
                <div
                  ...
                  role="alert"
                  v-if="data.maturityLevel.label != 'release' && data.maturityLevel.label != ''"
                >
                  This resource has maturity level
                  <strong>{{ this.data.maturityLevel.label }}</strong
                  >. Read more about
                  <customLink
                    class="custom-link"
                    :name="this.data.maturityLevel.label"
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <span v-if="data.taxonomy && data.taxonomy.value">
                      <p
                        v-for="(taxonomy, tIndex) in data.taxonomy.value"
              ...
              <div class="col-md-12 col-lg-8 col-xxl-12" v-else>
                <main v-if="!loader">
                  <article>
                    ...
                    <p>
                      AUTO Viewer is a JAVA application that is specifically designed to access both
                      the AUTO structure and its content in the easiest possible way. It can serve
                      both as a web application and REST API. AUTO Viewer is an open-source project
                      that is hosted by EDM Council. See
                      <a href="https://github.com/edmcouncil/onto-viewer"
                        >https://github.com/edmcouncil/onto-viewer</a
                      >
                      for details.
                    </p>
                    ...
                    <p class="text">
                      To fully benefit from the AUTO Viewer, one should keep in mind two very
                      important things about AUTO.
                    </p>
                    <p>
                      1) AUTO is a set of ontologies. It is organized in a hierarchical directory
                      structure to organize the ontologies. Top-level directories are called
                      <i>domains</i>; beneath that may be one or two levels of <i>sub-domain</i> and
                      then <i>modules</i> and dozens of <i>ontologies</i> at the bottom level:
                    </p>
                    ...
                    <p>
                      On the left-hand side, there is currently only one AUTO Domains: E-Commerce
                      vehicle information.
                    </p>
                    <br />
                    ...
                    <ul class="maturity-levels">
                      <li>
                        Release ontologies are ones that are considered to be stable and mature from
                  ...
                  <ul class="maturity-levels">
                    <li>
                      Informative ontologies are ones that are considered deprecated but 
                      included for informational purposes because it is referenced by some provisional concept.
                    </li>
                    ...
                    <p class="text">
                      ...
                      <a
                        href="https://spec.edmcouncil.org/auto/ontology/EC/SchemaAutomotive/AutoSchemaOrg/"
                        >https://spec.edmcouncil.org/auto/ontology/EC/SchemaAutomotive/AutoSchemaOrg/</a
                      >
                    </p>
                  </article>
                </main>
